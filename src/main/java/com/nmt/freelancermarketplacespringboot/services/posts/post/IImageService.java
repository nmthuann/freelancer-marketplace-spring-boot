...
public interface IImageService extends IBaseService<ImageEntity, UUID> {
    ...
    List<ImageEntity> insertImages (PostEntity postCreated, List<ImageDto> data) throws ModuleException; //InsertImagesDto data
    List<ImageEntity> updateImages (PostEntity postUpdated, List<ImageDto> data) throws ModuleException;
